...
public class URLTest2 {
	...
	public static void main(String[] args) throws IOException  {
		// URLConnection클래스 ==> 애플리케이션과 URL간의 통신연결을 위한 클래스
		
		// 특정 서버의 정보와 파일 내용을 가져와출력하는 예제
...
//		while(true)
//		{
//			String str = br.readLine();		//bufferReader는 한줄씩 읽을수있음
//			if(str==null) break;
...
//		br.close();
		...
		while(true)
		{
			String str = br2.readLine();		//bufferReader는 한줄씩 읽을수있음
			if(str==null) break;
			System.out.println(str);
		}
		br2.close();
