...
<form method="post" action="<%=request.getContextPath()%>/sessionLogin.do">
	<table border="1">
		<tr>
			<td> ID : </td>
			<td><input name="userid" value="" type="text" placeholder="ID를 입력하세요."></td>
		</tr>
		
		<tr>
			<td> PASS : </td>
			<td><input name="pass" value="" type="text" placeholder="PassWord를 입력하세요."></td>
		</tr>
