...
public class ArrayListTest01 
{
	...
	public static void main(String[] args) 
	{
		...
		// 데이터 변경하기
		String temp = (String)list1.set(3, "yes");
		...
		// indexOf(비교객체) ==> 리스트에 '비교객체'가 있으면 '비교객체'가 위치한 index값을
		//					    반환하고 '비교객체'가 없으면 -1을 반환한다.
		
		System.out.println("DDDDD값 의 위치 : " + list2.indexOf("DDDDD"));
		System.out.println("DDDD값 의 위치 : " + list2.indexOf("DDDD"));
		System.out.println("-------------------------------------------");
		System.out.println();
