...
/*
	...
	방법2) 각각의 상수에 임의의 값을 설정 할 수 있는 열거형 만들기
		enum 열거형이름{
			상수명1(값들...),
			상수명2(값들...),
			...
...
//		}
		...
		Count myCnt = Count.valueOf("ONE");				// == Color.One과 같다.
...
//		 switch문에서 비교
//		 switch문의 case에 상수명을 지정할 때는 '열거형 이름'을 생략하고
//					'상수명'만 지정한다.
		switch(myCnt)
		{
...
//			break;
		case ONE:
			System.out.println("상수 ONE");break;
		case TWO:
			System.out.println("상수 TWO");break;
		case THREE:
			System.out.println("상수 TRHEE");break;
		}
